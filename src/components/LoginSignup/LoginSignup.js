...
class LoginSignup extends Component {
  ...
  //   this allows us to set the state of form on toggle
  toggle = {
    login: "register",
    register: "login",
  };
  ...
  handleLogin = async (e) => {
    ...
    if (this.state.form === "register") {
      ...
      //   below, we are setting two different user variables so that we can asynchronously register a user (userR) and post a login (user)
      //   using one in place of the other results in errors
      const userR = {
      ...
      //	this is where we are asynchronously registering a new user and the logging that user in
      //	we're doing this to create a smoother user flow
      try {
